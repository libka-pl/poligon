# -*- coding: utf-8 -*-
# source => github.com/dawoudt/JustWatchAPI
...
HEADER = {'User-Agent': client.randomagent()}
...
class JustWatch:
    ...
    def set_locale(self):
        warn = 'JustWatch API WARN: Unable to locale for {}! Defaulting to en_AU'
        ...
        try:
            ...
            print(warn.format(self.country))
