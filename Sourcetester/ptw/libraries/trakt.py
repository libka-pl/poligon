...
V2_API_KEY = apis.trakt_API #"ccb4fbf0447d86edf30f71caf8f6a8c268e8d4014f84e536746b69752407bfd5"
CLIENT_SECRET = apis.trakt_secret #"ed7cff6b0c686789f101c91a5733d5b3e5122bafd1328f31dbd440d6fb5f4cbf"
...
def manager(name, imdb, tmdb, content):
    try:
        ...
        select = control.selectDialog(
            [i[0] for i in items], control.lang(32515)
        )
